...
function ShowSwiper(data) {
    ...
    if (data.data.detail.photo.length == 0) {
        ...
        let str = data.data.detail.photo.map((item) => {
                return ` <div class="swiper-slide"><img src="${item.url}" style="width: 100%; height: 100%;" alt=""></div>`
            })
